...
const api = {
  ...
  soundAvailability: () => ipcRenderer.invoke("axm:soundAvailability"),
  bootSound: (choice: string) => ipcRenderer.invoke("axm:bootSound", choice),
  launchSound: (platform: string, enabled: boolean) => ipcRenderer.invoke("axm:launchSound", platform, enabled),
  menuMusicTrack: (enabled: boolean) => ipcRenderer.invoke("axm:menuMusicTrack", enabled),
  launchImage: (platform: string) => ipcRenderer.invoke("axm:launchImage", platform),
  planGameTransfer: (game: unknown, targetDrive: string) => ipcRenderer.invoke("axm:planGameTransfer", game, targetDrive),
  transferGame: (game: unknown, targetDrive: string, mode: "move" | "copy") => ipcRenderer.invoke("axm:transferGame", game, targetDrive, mode),
  uninstallGame: (game: unknown) => ipcRenderer.invoke("axm:uninstallGame", game),
  gameLauncher: (game: unknown) => ipcRenderer.invoke("axm:gameLauncher", game),
  cartridgeArtwork: (drive: string, games: { name: string; filePath: string }[]) => ipcRenderer.invoke("axm:cartridgeArtwork", drive, games),
  clearCartridgeArtwork: (drive: string) => ipcRenderer.invoke("axm:clearCartridgeArtwork", drive),
