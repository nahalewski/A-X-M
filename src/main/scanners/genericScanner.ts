...
const IGNORE_EXE_PATTERN =
  /(^unins|setup|redist|vcredist|dxsetup|crashhandler|crashpad|easyanticheat|battleye|eossdk|ue4prereq|directx|dotnet|vc_redist|helper|updater|launcher-service|cef|report|dump)/i;
